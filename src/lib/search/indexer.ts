 ...
 * NOTE: These "tags" are ONLY for search terms, not for the UI tag logic.
 * UI tags must come from tags.ts (JSON mapping + heuristics).
 */
...
/**
 * Converts arrays of spells and features to index docs.
 * The second param is optional for syntactic compatibility (e.g., toDocs(spells)).
 * We intentionally do NOT derive "buff" here—keep semantic tags in tags.ts.
 */
